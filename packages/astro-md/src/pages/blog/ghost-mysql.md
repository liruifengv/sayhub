...
上一篇文章[使用 Ghost 从零搭建博客系统](https://zhuanlan.zhihu.com/p/435203692) 写了如何搭建 Ghost，但是 Ghost 默认使用 SQLite 数据库，我们想使用 mysql 数据库，这篇文章就实践一下。
...
往期文章：[使用 Ghost 从零搭建博客系统](https://zhuanlan.zhihu.com/p/435203692)
